                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input id="fNacimiento" type="date" class="form-control @error('fNacimiento') is-invalid @enderror" name="fNacimiento" required autocomplete="fNacimiento">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-6">
                                <input type="radio" id="normal" name="tipoUsuario" value="normal" checked>
                                <label for="normal">Normal</label>
                                <input type="radio" id="editor" name="tipoUsuario" value="editor">

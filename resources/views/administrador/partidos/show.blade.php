                                    ...
                                    <div class="col-4 ">
                                        ...
                                        <label for="cornerL">
                                            ...
                                            <input type="number" name="cornerL" placeholder="Corner"
                                                class="form-control mb-2 text-center"
                                                value="{{$estadisticaLocal->corner}}" readonly>
                                        </label>
                                        <br>
                                        <label for="offsideL">
                                            <p class="text-center p-1 text-light" style="background-color: #002766;">
                                            ...
                                            <input type="number" name="offsideL" placeholder="Offside"
                                                class="form-control mb-2 text-center"
                                                value="{{$estadisticaLocal->offside}}" readonly>
                                        </label>
                                        <br>
                                        ...
                                        <label for="faltasL">
                                            ...
                                            <input type="number" name="faltasL" placeholder="Faltas"
                                                class="form-control mb-2 text-center"
                                                value="{{$estadisticaLocal->faltas}}" readonly>
                                        </label>
                                        <br>
                                        ...
                                        <label for="rojasL">
                                            ...
                                            <input type="number" name="rojasL" placeholder="Rojas"
                                                class="form-control mb-2 text-center"
                                                value="{{$estadisticaLocal->rojas}}" readonly>
                                        </label>
                                        <br>
                                    </div>
                                    <div class="col-4">
